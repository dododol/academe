...
public class Home {
	...
	public static void main(String[] args) {
		...
		if(a1 < 50) {
			System.out.println("a1은 작습니다");
		}else {
			System.out.println("a1이 큽니다");
		}
		...
		if(a2 < 50) {
			System.out.println("a2은 작습니다");
		}else {
			System.out.println("a2이 큽니다");
		}
		
		// 문제 3. 변수 a1이 10보다 크고 50보다 작은 숫자인 경우 "a1은 10보다 크고 50보다 작습니다"를 출력해주세요.

		if(a1 > 10 && a1 <50) {
			System.out.println("a1은 10보다 크고 50보다 작습니다");
		}
		
		// 문제 4. 변수 a2가 50보다 크고 100보다 작은 숫자인 경우 "a2는 50보다 크고 100보다 작습니다"를 출력해주세요.

		if(a2 >50 && a2 < 100) {
			System.out.println("s2는 50보다 크고 100보다 작습니다");
		}
		...
		if(a1 < 30 || a2 < 30) {
			System.out.println("a1또는 a2가 30보다 작습니다");
		}
		...
		if(a1 >= 100) {
			...
			System.out.println("a1은 100 이상이 아닙니다");
		}
		...
		if(str2 == "") {
			System.out.println("str2는 공백입니다");
		}
		...
		if(str3 == "") {
			...
			System.out.println("str3은 공백이 아닙니다");
		}
		...
		if(flag2 == true) {
			System.out.println("flag2는 true입니다");
		}
		...
		if(f2 >= 10 && f2 <= 20) {
			System.out.println("f2는 10이상 20이하입니다");
		} else {
			System.out.println("해당사항 없습니다");
		}

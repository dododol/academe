...
public class LoginService {
	...
	// 기본 생성자로는 인스턴스를 만들수 없으므로 getInstance() 함수를 이용하여
	// LoginService 객체를 만들수 있도록 getInstace() 함수를 생성합니다.
	...
	// DB로 요철할 기능을 DAO한테 요청하고 결과를 받기 위해서 DAO를 부를수 밖에 없습니다.

...
%>		
	...
	<section id="mid"> 
	 ...
	 <li><a href="<%=request.getContextPath()%>/html/응원단.jsp" id="g7">응원단</a></li>		
		...
		<div id="photo"><img id="photo1" src="<%=request.getContextPath()%>/resources/images/포수김재성.png"></div>
		<div id="name" class="stat"><span class="name">김재성</span></div>
		<div id="num" class="stat"><span class="upstat">01</span></div>
		<div id="poji" class="stat"><span class="upstat" id="korean">4번타자</span></div>
		<div id="hand" class="stat"><span class="upstat" id="korean">우타</span></div>
		...
		<div id="win" class="stat"><span class="downstat" id="susja1">27</span></div>
		<div id="pso" class="stat"><span class="downstat" id="susja2">10</span></div>
		<div id="hold" class="stat"><span class="downstat" id="susja3">49</span></div>
		<div id="save" class="stat"><span class="downstat" id="susja4">37</span></div>
		<div id="ining" class="stat"><span class="downstat" id="susja5">14</span></div>
		<div id="ppb" class="stat"><span class="downstat" id="susja6">09</span></div>
		<img src="../resources/images/타자프로필.png"> <br>

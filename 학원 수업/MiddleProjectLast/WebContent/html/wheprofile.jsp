...
%>		
	...
	<section id="mid"> 
	 ...
	 <li><a href="<%=request.getContextPath()%>/html/응원단.jsp" id="g7">응원단</a></li>		 
		...
		<div id="photo"><img id="photo1" src="<%=request.getContextPath() %>/<%=wheInfo.getP_img2()%>"></div>
		<div id="name" class="stat"><span class="name"><%=wheInfo.getP_name() %></span></div>
		<div id="num" class="stat"><span class="upstat"><%=wheInfo.getP_no() %></span></div>
		<div id="poji" class="stat"><span class="upstat" id="korean"><%=wheInfo.getP_position() %></span></div>

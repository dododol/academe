...
List<PlayerVO> array = (List<PlayerVO>)request.getAttribute("tusu");
...
%>		
	...
	<section id="mid"> 
	 ...
	 <li><a href="<%=request.getContextPath()%>/히스토리.jsp" id="g7">응원단</a></li> 
		...
		<div id="photo"><img id="photo1" src="<%=request.getContextPath() %>/<%=array.get(0).getP_img2()%>"></div>
		<div id="name" class="stat"><span class="name"><%=array.get(0).getP_name() %></span></div>
		<div id="num" class="stat"><span class="upstat"><%=array.get(0).getP_no() %></span></div>
		<div id="poji" class="stat"><span class="upstat" id="korean"><%=array.get(0).getP_position() %></span></div>
		<div id="hand" class="stat"><span class="upstat" id="korean"><%=array.get(0).getLr() %></span></div>
		<div id="age" class="stat"><span class="upstat" id="korean"><%=array.get(0).getP_age() %></span></div>
		<div id="date" class="stat"><span class="upstat" id="korean"><%=array.get(0).getP_hdate() %></span></div>

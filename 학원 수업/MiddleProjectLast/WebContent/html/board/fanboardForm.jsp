...
$(function(){
	$("#listBtn").on("click", function(){
		...
		addBtn.on("click", function(){
			...
			var content = $("#fanboard_content").val();
...
<%--작성 시작부분 --%>
<section>
<form id="fanBoardForm" action="<%=request.getContextPath() %>/board/fanBoardForm.do" method="post" enctype="multipart/form-data">
<div class="all">
<div class="topwrite"><span class="topwrite2">팬 여러분의 소통 공간입니다</span></div>
<div class="fantb">
<table class="fanwrtb">
<tbody>
	...
	<tr>
		...
		<td class="title">
			<input type="text" name="fanboard_title" id="fanboard_title">
		</td>
	</tr>
	<tr>
		<td class="title">작성자</td>
		<td class="title"><input type="text" name="fanboard_writer" id="fanboard_writer" value="<%=loginId.getMem_id()%>" readonly="readonly"></td>
	</tr>
	<tr>
		<td class="title">내용</td>
		<td class="title"><textarea rows="20" cols="60" id="fanboard_content" name="fanboard_content" plcaeholder="내용을 입력하세요."></textarea></td>
	</tr>
	<tr>
    ...
    <input type="file" id="file" name="files" multiple="multiple">
			...
			<input class="fanbtn" type="submit" id="addBtn" value="등록"> 

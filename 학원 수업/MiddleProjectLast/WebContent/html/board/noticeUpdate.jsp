...
<%
	NoticeVO notiVo = (NoticeVO)request.getAttribute("UpdateNotiVO");
%> 

<section>
<form id="noticeForm" action="<%=request.getContextPath() %>/board/noticeUpdateView.do" method="get" enctype="multipart/form-data">
<div class="all">
<div class="topwrite"><span class="topwrite2">구단의 소식을 전해드립니다</span></div>
<div class="fantb">
<table class="fanwrtb">
<tbody>
	...
	<tr>
		...
		<td class="title">
			<input type="text" name="notice_title" id="notice_title" value="<%=notiVo.getN_title()%>">
		</td>
	</tr>
	<tr>
		<td class="title">작성자</td>
		<td class="title"><input type="text" name="notice_writer" id="notice_writer" value="<%=notiVo.getMem_id()%>" readonly="readonly"></td>
	</tr>
	<tr>
		<td class="title">내용</td>
		<td class="title"><textarea rows="20" cols="60" id="notice_content" name="notice_content"><%=notiVo.getN_content()%></textarea></td>
	</tr>
	<tr>
        <td class="title">파일 첨부</td>
		<td class="title1"><div class="filebox">
    <input class="upload-name" value="첨부파일" placeholder="첨부파일">
    <input id="notice_no" name="notice_no" type="hidden" value="<%=notiVo.getN_no()%>">

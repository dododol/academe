...
<%--작성 시작부분 --%>
<section>
<form id="fanBoardForm" action="<%=request.getContextPath() %>/board/qnaForm.do" method="post">
<div class="all">
...
<tbody>
	<tr>
		...
		<td class="title">
			<input type="text" name="qna_title" id="qna_title" placeholder="제목을 입력해주세요.">
		</td>
	</tr>
	<tr>
		<td class="title">작성자</td>
		<td class="title"><input type="text" name="qna_writer" id="qna_writer" value="<%=loginId.getMem_id()%>" readonly="readonly"></td>
	</tr>
	<tr>
		<td class="title">비밀번호</td>
		<td class="title"><input type="text" name="qna_pass" id="qna_pass" value="" placeholder="비밀글 원 할시에는 숫자 10자 이내로 작성해주새요."></td>
	</tr>
	<tr>
		<td class="title">내용</td>
		<td class="title"><textarea rows="20" cols="60" id="qna_content" name="qna_content" placeholder="내용을 입력하세요."></textarea></td>
	</tr>

...
<%--작성 시작부분 --%>
<section>
<form id="noticeForm" action="<%=request.getContextPath() %>/board/noticeForm.do" 
...
<tbody>
	...
	<tr>
		...
		<td class="title"><input type="text" name="notice_writer" id="notice_writer" value="<%=loginId.getMem_id()%>" readonly="readonly"></td>
	</tr>
	<tr>
		<td class="title">내용</td>
		<td class="title"><textarea rows="20" cols="60" id="notice_content" name="notice_content" plcaeholder="내용을 입력하세요."></textarea></td>
	</tr>
	<tr>

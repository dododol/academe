...
<link href="<%=request.getContextPath()%>/resources/css/팬게시판list.css"
...
<body>
	...
	%>
	<header>
		<a id="imga" href="<%=request.getContextPath()%>/html/main.jsp"><img
	...
	<header>
		...
		<div id="log1">
			<ul>
				<li class="log"><a
					href="<%=request.getContextPath()%>/adminManager.do" id="ma"><i
						class="fa fa-user"></i> 예매 내역 조회</a> <br>
				<li class="log"><a
					href="<%=request.getContextPath()%>/adminManager.do" id="ma"><i
						class="fa fa-user"></i> 매출 조회</a> <br>
				<li class="log"><a
					href="<%=request.getContextPath()%>/adminManager.do" id="ma"><i
						class="fa fa-user"></i> 고객 조회</a> <br></li>
				<li class="log"><a
					href="<%=request.getContextPath()%>/logout.do" id="logout"
					method="get">로그아웃</a></li>
	 ...
	 <li><a href="<%=request.getContextPath()%>/html/언더독스파크.jsp">언더독스 파크</a></li>
				...
				<li><a href="#" id="ma">FAN</a>
					<div class="an2">
						<ul id="an">
							<li><a
								href="<%=request.getContextPath()%>/board/noticelist.do" id="g1">구단소식</a></li>
							<li><a
								href="<%=request.getContextPath()%>/board/fanboardlist.do"
								id="g2">팬게시판</a></li>
							<li><a href="<%=request.getContextPath()%>/board/qnaList.do">문의사항</a></li>
						</ul>
					</div></li>
				<li><a href="<%=request.getContextPath()%>/matchInfo.do"
					id="ma">GAME</a></li>
				<li><a target="_blank"
					href="<%=request.getContextPath()%>/ticket.do" id="ma">TICKET</a>
				</li>
				<li><a href="<%=request.getContextPath()%>/liveGame.do"
					id="ma">LIVE GAME</a>
			</ul>
		</div>
	</nav>
	...
	<section class="article-list table-common con">
		<div class="gudan">
			<ul id="an">
				<li><a href="<%=request.getContextPath()%>/board/noticelist.do"
					id="g1">구단소식</a></li>
				<li><a
					href="<%=request.getContextPath()%>/board/fanboardlist.do" id="g2">팬게시판</a></li>
				<li><a href="<%=request.getContextPath()%>/board/qnaList.do">문의사항</a></li>
			</ul>
		</div>
		<br>
		<div id="tablediv">
			<form action="<%=request.getContextPath()%>/board/qnaTitleSearch.do"
				method="post">
				...
				<div class="search">
					<input class="form-controlme-2" type="text" id="sword" name="sword"
						placeholder="아이디를 입력해주세요.">
					<button id="searchbt" class="btn btn-primary" type="submit">
			...
			<table id="fanBoard">
				<caption id="fanBoardName">문의 사항</caption>
				<thead id="fanthead">
					<tr class="fantr">
				...
				<tbody id="tBody">
					...
					<tr>
						<td colspan="5">
							<p style="text-align: center;">조회하실 게시물이 존재하지 않습니다.</p>
						</td>
					</tr>
					...
					<tr class="tdtr">
						<td id="passNo" class="fantd"><%=qVo.getQ_no()%></td>
						<%
							int pass = qVo.getQ_pass();
						if (pass == 0) {
						%>
						<td class="fantd"><a id="tdsub"
							href="<%=request.getContextPath()%>/board/QnaDetail.do?qnano=<%=qVo.getQ_no()%>&qnaid=<%=qVo.getMem_id()%>"><%=qVo.getQ_title()%></a></td>
						<%
							} else if (pass != 0) {
						%>

						<td class="fantd" id="passOpen" data-no="<%=qVo.getQ_no()%>"
							data-pass="<%=qVo.getQ_pass()%>" data-id="<%=qVo.getMem_id()%>"><i
							id="icon" class="fa fa-lock"></i>비공개 게시글 입니다.</td>

						<%
							}
						%>

						<td class="fantd" id="passId"><%=qVo.getMem_id()%></td>
						<td class="fantd"><%=qVo.getQ_date()%></td>
						<td class="fantd"><%=qVo.getQ_hit()%></td>
					</tr>

...
<%
	FanBoardVO fanVo = (FanBoardVO)request.getAttribute("UpdateFanVO");
%> 

<section>
<form id="fanBoardForm" action="<%=request.getContextPath() %>/board/fanboardUpdateView.do" method="post" >
<input type="hidden" name="fanboard_no" value="<%=fanVo.getB_no()%>">
<div class="all">
<div class="topwrite"><span class="topwrite2"><%=fanVo.getB_no()%>번 게시글 수정</span></div>
<div class="fantb">
<table class="fanwrtb">
<caption><%=fanVo.getB_no()%>번 게시글 수정</caption>
<tbody>
	
	<tr>
		<td class="title">제목</td>
		<td class="title">
			<input type="text" name="fanboard_title" id="fanboard_title" value="<%=fanVo.getB_title()%>">
		</td>
	</tr>
	<tr>
		<td class="title">작성자</td>
		<td class="title"><input type="text" name="fanboard_writer" id="fanboard_writer" value="<%=fanVo.getMem_id()%>" disabled="disabled"></td>
	</tr>
	<tr>
		<td class="title">내용</td>
		<td class="title"><textarea rows="20" cols="60" id="fanboard_content" name="fanboard_content"><%=fanVo.getB_content()%></textarea></td>
	</tr>
		<tr>
		<td class="title">파일 첨부</td>
		<td class="title1"><div class="filebox">

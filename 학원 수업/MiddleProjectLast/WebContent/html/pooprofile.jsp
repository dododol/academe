...
%>		
	...
	<section id="mid"> 
	 ...
	 <li><a href="<%=request.getContextPath()%>/html/응원단.jsp" id="g7">응원단</a></li>		 
		...
		<div id="win" class="stat"><span class="downstat" id="korean"><%=pooBatter.getSingles() %></span></div>
		<div id="pso" class="stat"><span class="downstat" id="susja"><%=pooBatter.getDoubles() %></span></div>
		<div id="hold" class="stat"><span class="downstat" id="susja"><%=pooBatter.getTriples() %></span></div>
		<div id="save" class="stat"><span class="downstat" id="susja"><%=pooBatter.getStrikeouts() %></span></div>
		<div id="ining" class="stat"><span class="downstat" id="susja"><%=pooBatter.getBb() %></span></div>
		<div id="ppb" class="stat"><span class="downstat" id="susja"><%=pooBatter.getHr() %></span></div>
		
		<img src="<%=request.getContextPath() %>/resources/images/타자프로필.png"> <br>

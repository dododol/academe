...
public class TicketVO {
	...
	private String b_num;
	   ...
	   public void setB_no(String b_num) {
	      this.b_num = b_num;
	   }
	   ...
	   public String toString() {
	      return "TicketVO [b_num=" + b_num + ", m_date=" + m_date + ", b_seat=" + b_seat + ", b_price=" + b_price
	            + ", s_section=" + s_section + ", mem_id=" + mem_id + ", b_bdate=" + b_bdate + ", b_stat=" + b_stat
	            + ", b_totalprice=" + b_totalprice + ", b_counttticket=" + b_counttticket + ", s_price=" + s_price
	            + ", a_name=" + a_name + "]";
	   }

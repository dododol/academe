...
<!-- 		<th>비밀번호</th> -->
<!-- 		<td> -->
<!-- 			<input type="text" name="memPass" id="memPass">  -->
<!-- 		</td> -->
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<th>주민번호1</th> -->
<!-- 		<td> -->
<!-- 			<input type="text" name="memRegno1" id="memRegno1">  -->
<!-- 		</td> -->
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<th>주민번호2</th> -->
<!-- 		<td> -->
<!-- 			<input type="text" name="memRegno2" id="memRegno1"> -->
<!-- 		</td> -->
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<th>생일</th> -->
<!-- 		<td> -->
<!-- 			<input type="datetime-local" name="memBir" id="memBir"> -->
<!-- 		</td> -->
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<th>우편번호</th> -->
<!-- 		<td> -->
<!-- 			<input type="text" name="memZip" id="memZip"> -->
<!-- 		</td> -->
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<th>주소1</th> -->
<!-- 		<td> -->
<!-- 			<input type="text" name="memAdd1" id="memAdd1"> -->
<!-- 		</td> -->
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<th>주소2</th> -->
<!-- 		<td> -->
<!-- 			<input type="text" name="memAdd2" id="memAdd2"> -->
<!-- 		</td> -->
<!-- 	</tr> -->

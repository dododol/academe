...
<meta charset="utf-8">
<title>포수 소개</title>
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/포수소개.css">
...
List<PlayerVO> array = (List<PlayerVO>)request.getAttribute("playerInfo1");
...
$(function(){
	$(".clsTusu").on("click",function(){
		...
		location.href="<%=request.getContextPath()%>/pooInfo.do?id="+id;
	});
});
</script>

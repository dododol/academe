...
<meta charset="utf-8">
<title>외야수 소개</title>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/외야수.css">
...
List<PlayerVO> array = (List<PlayerVO>)request.getAttribute("playerInfo3");
...
<div class="main">
	...
	<div class="an2">	  
	 ...
	 <li><a href="poo.jsp">포수</a></li>
	 <li><a href="nae.jsp">내야수</a></li>
	 <li><a href="whe.jsp">외야수</a></li>
	 <li><a href="#">응원단</a></li>	
     </ul>
	      </div>
		</li>
	...
	<section id="mid">
	 ...
	 <li><a href="poo.jsp" id="g4">포수</a></li>
	 <li><a href="nae.jsp" id="g5">내야수</a></li>
	 <li><a href="whe.jsp" id="g6">외야수</a></li>
...
$(function(){
	$(".clsTusu").on("click",function(){
		...
		location.href="<%=request.getContextPath()%>/wheInfo.do?id="+id;
	});
});
</script>
</body>
